...
<body>
	<%@ include file="header.jsp"%>
	   ...
	   <ol class="breadcrumb">
		  <li><a href="#">小米商城</a></li>
		  <li><a href="#">手机</a></li>
		  <li class="active"><a href="getGoodsListByTypeId?typeid=${goods.id}">${goods.name}</a></li>
	   </ol>
   </div>
			  ...
			  <div class="panel-body">
			    ...
			    <div style="margin-left: 10px;">
				   ...
				   <p>市场价格:&nbsp;&nbsp;&nbsp;<span class="text-danger" style="font-size: 15px;">${goods.price}</span>&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-yen"></span></p>
				    ...
				    <p>详细介绍:</p>
				    <p>&nbsp;&nbsp;${goods.summary }</p>
				    <a href="${pageContext.request.contextPath}/product?action=addCart&goodsId=${goods.id}&price=${goods.price}" class="btn btn-warning">加入购物车&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-shopping-cart"></span></a>&nbsp;&nbsp;&nbsp;
